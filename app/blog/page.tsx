...
import { ChevronRight, BookOpen, Calendar, User, Clock, Search, Tag, TrendingUp, Zap, Lightbulb, Award } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-gray-50 to-white py-16">
        <div className="container-wide relative z-10">
          <div className="text-center">
            ...
            <h1 className="font-phonic text-4xl md:text-6xl font-normal tracking-tight text-gray-900 mb-4">
              Insights & Updates
            </h1>
            <p className="font-capsule text-base font-normal text-gray-600 max-w-2xl mx-auto px-4 md:px-0">
              Stay updated with the latest in cryptocurrency payments, industry insights, and Cryptrac platform updates
            </p>
            
            {/* Search Bar */}
            <div className="max-w-md mx-auto mt-8 px-4 md:px-0">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-12 h-12 md:h-10 text-base focus:ring-[#7f5efd] focus:border-[#7f5efd]"
                />
                {searchTerm && (
                  <button
      ...
      <div className="container-wide py-8 px-4 md:px-8">
        {/* Category Filter */}
        <div className="flex flex-wrap gap-2 mb-8 justify-center px-2 md:px-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            {!searchTerm && selectedCategory === "All" && featuredPosts.length > 0 && (
              <div className="mb-12">
                <h2 className="font-phonic text-xl md:text-2xl font-normal text-gray-900 mb-4 md:mb-6 flex items-center gap-2">
                  ...
                  {featuredPosts.map((post) => (
                    <Card key={post.id} className="border-[#7f5efd]/20 bg-[#f5f3ff]/30 hover:shadow-lg transition-shadow">
                      <CardHeader>
                        ...
                        <CardTitle className="font-phonic text-lg md:text-xl font-normal text-gray-900 line-clamp-2">
                          {post.title}
                        </CardTitle>
                      </CardHeader>
                      <CardContent>
                        <p className="font-capsule text-base md:text-sm font-normal text-gray-600 mb-4 line-clamp-3">
                          {post.excerpt}
                        </p>
                        <div className="flex items-center justify-between text-sm md:text-xs text-gray-500 mb-4">
                        ...
                        <div className="flex flex-wrap gap-1 mb-4">
                          {post.tags.slice(0, 3).map((tag, index) => (
                            <Badge key={index} variant="secondary" className="text-sm md:text-xs">
                              {tag}
                            </Badge>
                          ))}
                        </div>
                        <Button variant="ghost" size="sm" className="font-phonic text-base md:text-sm font-normal text-[#7f5efd] hover:text-[#6547e8] min-h-[44px] md:min-h-0 md:h-auto p-2 md:p-0" asChild>
            ...
            <div>
              <h2 className="font-phonic text-xl md:text-2xl font-normal text-gray-900 mb-4 md:mb-6 flex items-center gap-2">
                <BookOpen className="h-5 md:h-6 w-5 md:w-6 text-[#7f5efd]" />
                {searchTerm 
              ...
              {filteredPosts.length === 0 ? (
                <Card className="p-8 text-center">
                  ...
                  <h3 className="font-phonic text-base md:text-lg font-normal text-gray-900 mb-2">
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <h3 className="font-phonic text-lg md:text-xl font-normal text-gray-900 mb-3 line-clamp-2">
                              {post.title}
                            </h3>
                            <p className="font-capsule text-base md:text-sm font-normal text-gray-600 mb-4 line-clamp-2">
                              {post.excerpt}
                            </p>
                            <div className="flex flex-wrap items-center gap-3 md:gap-6 text-sm md:text-xs text-gray-500 mb-4">
                              <div className="flex items-center gap-1">
                                <User className="h-3 w-3" />
                                {post.author}
                              </div>
            ...
            <div className="lg:sticky lg:top-24 space-y-6 md:space-y-8">
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {["Bitcoin", "Security", "Stablecoins", "Getting Started", "Payments", "E-commerce", "Wallets", "Blockchain"].map((topic, index) => (
                      <Badge key={index} variant="secondary" className="text-sm md:text-xs cursor-pointer hover:bg-[#7f5efd] hover:text-white transition-colors py-2 md:py-1">
                        {topic}
                      </Badge>
                    ))}
                  </div>
              ...
              <Card className="shadow-lg border-[#7f5efd]/20 bg-[#f5f3ff]/30">
                ...
                <CardContent>
                  ...
                  <div className="space-y-3">
                    <Input type="email" placeholder="Enter your email" className="text-base md:text-sm h-12 md:h-10" />
              ...
              <Card className="shadow-lg">
                ...
                <CardContent className="space-y-3">
                  <Link href="/merchant/onboarding" className="flex items-center justify-between p-3 md:p-2 rounded-lg hover:bg-gray-50 transition-colors min-h-[44px] md:min-h-0">
                    <span className="font-phonic text-base md:text-sm font-normal text-gray-700">Get Started</span>
                    <ChevronRight className="h-4 w-4 text-gray-400" />
                  </Link>
                  <Link href="/smart-terminal" className="flex items-center justify-between p-3 md:p-2 rounded-lg hover:bg-gray-50 transition-colors min-h-[44px] md:min-h-0">
                    <span className="font-phonic text-base md:text-sm font-normal text-gray-700">Smart Terminal</span>
                    <ChevronRight className="h-4 w-4 text-gray-400" />
                  </Link>
                  <Link href="/security" className="flex items-center justify-between p-3 md:p-2 rounded-lg hover:bg-gray-50 transition-colors min-h-[44px] md:min-h-0">
                    <span className="font-phonic text-base md:text-sm font-normal text-gray-700">Security</span>
                    <ChevronRight className="h-4 w-4 text-gray-400" />
                  </Link>
                  <Link href="/about" className="flex items-center justify-between p-3 md:p-2 rounded-lg hover:bg-gray-50 transition-colors min-h-[44px] md:min-h-0">
                    <span className="font-phonic text-base md:text-sm font-normal text-gray-700">About Cryptrac</span>
                    <ChevronRight className="h-4 w-4 text-gray-400" />
                  </Link>
                  <Link href="/contact" className="flex items-center justify-between p-3 md:p-2 rounded-lg hover:bg-gray-50 transition-colors min-h-[44px] md:min-h-0">
                    <span className="font-phonic text-base md:text-sm font-normal text-gray-700">Contact Support</span>
                    <ChevronRight className="h-4 w-4 text-gray-400" />
                  </Link>
                </CardContent>
              </Card>
