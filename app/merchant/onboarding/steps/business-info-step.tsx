              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={`form-input-enhanced ${errors.firstName ? 'border-red-300 focus:border-red-500' : ''}`}
                  />
                  {errors.firstName && (
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={`form-input-enhanced ${errors.lastName ? 'border-red-300 focus:border-red-500' : ''}`}
                  />
                  {errors.lastName && (
