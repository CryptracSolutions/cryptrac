...
import { ArrowLeft, ChevronRight, Shield, Users, Eye, Lock, Settings, AlertCircle, Clock, Phone, Mail, MapPin, FileText, Database, CreditCard, Globe } from "lucide-react";
              ...
              <div className="prose prose-gray max-w-none">
                ...
                <section id="information-collected" className="mb-12">
                  ...
                  <div className="space-y-6">
                    <Card className="border-[#7f5efd]/20 bg-[#f5f3ff]/30">
                      <CardHeader>
                        <CardTitle className="text-lg text-gray-900">Account and Profile Information</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <p className="text-gray-700">Collected when you register for a merchant account or interact with our Service:</p>
                    ...
                    <Card className="border-gray-200">
                      <CardHeader>
                        <CardTitle className="text-lg text-gray-900">Financial and Payment Information</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <p className="text-gray-700">Essential for our cryptocurrency payment processing services:</p>
                        <ul className="space-y-2 text-sm text-gray-600">
                          <li className="flex items-start gap-2">
                            <ChevronRight className="h-4 w-4 text-[#7f5efd] mt-0.5" />
                    ...
                    <Card className="border-gray-200">
                      <CardHeader>
                        <CardTitle className="text-lg text-gray-900">Transaction Data</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <p className="text-gray-700">Comprehensive records of all payment activities:</p>
                        <ul className="space-y-2 text-sm text-gray-600">
                          <li className="flex items-start gap-2">
                            <ChevronRight className="h-4 w-4 text-[#7f5efd] mt-0.5" />
                    ...
                    <Card className="border-gray-200">
                      <CardHeader>
                        <CardTitle className="text-lg text-gray-900">Technical Information</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <p className="text-gray-700">Automatically collected to ensure proper functionality and security:</p>
                        <ul className="space-y-2 text-sm text-gray-600">
                          <li className="flex items-start gap-2">
                            <ChevronRight className="h-4 w-4 text-[#7f5efd] mt-0.5" />
                ...
                <section id="how-we-use" className="mb-12">
                  ...
                  <div className="space-y-6">
                    <Card className="border-[#7f5efd]/20 bg-[#f5f3ff]/30">
                      <CardHeader>
                        <CardTitle className="text-lg text-gray-900">Service Provision and Operation</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <p className="text-gray-700">Our primary use of your information:</p>
                        <ul className="space-y-2 text-sm text-gray-600">
                          <li className="flex items-start gap-2">
                            <ChevronRight className="h-4 w-4 text-[#7f5efd] mt-0.5" />
                    ...
                    <Card className="border-red-200 bg-red-50">
                      ...
                      <CardContent className="space-y-3">
                        <p className="text-red-800 mb-3">Critical aspect of our operations, particularly given the irreversible nature of cryptocurrency transactions:</p>
                    ...
                    <Card className="border-blue-200 bg-blue-50">
                      ...
                      <CardContent className="space-y-3">
                        <p className="text-blue-800 mb-3">Meeting various regulatory requirements in the financial services and cryptocurrency sectors:</p>
                    ...
                    <Card className="border-green-200 bg-green-50">
                      ...
                      <CardContent className="space-y-3">
                        <p className="text-green-800 mb-3">Using aggregated and anonymized data to enhance our platform:</p>
                ...
                <section id="information-sharing" className="mb-12">
                  ...
                  <div className="space-y-6">
                    <Card className="border-[#7f5efd]/20 bg-[#f5f3ff]/30">
                      <CardHeader>
                        <CardTitle className="text-lg text-gray-900">Service Providers and Business Partners</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <p className="text-gray-700">Limited access to your information as necessary to support our operations:</p>
                        
                        <div className="grid md:grid-cols-2 gap-4">
                          <Card className="border-gray-200">
                            <CardHeader className="pb-3">
                              <CardTitle className="text-sm text-gray-900">NOWPayments</CardTitle>
                            </CardHeader>
                            <CardContent>
                              <p className="text-xs text-gray-600 mb-2">Primary cryptocurrency payment processor</p>
                          ...
                          <Card className="border-gray-200">
                            <CardHeader className="pb-3">
                              <CardTitle className="text-sm text-gray-900">Supabase</CardTitle>
                            </CardHeader>
                            <CardContent>
                              <p className="text-xs text-gray-600 mb-2">Database and authentication provider</p>
                              <ul className="space-y-1 text-xs text-gray-500">
                          ...
                          <Card className="border-gray-200">
                            <CardHeader className="pb-3">
                              <CardTitle className="text-sm text-gray-900">SendGrid</CardTitle>
                            </CardHeader>
                            <CardContent>
                              <p className="text-xs text-gray-600 mb-2">Email service provider</p>
                              <ul className="space-y-1 text-xs text-gray-500">
                    ...
                    <Card className="border-blue-200 bg-blue-50">
                      <CardHeader>
                        <CardTitle className="text-lg text-blue-900">Legal and Regulatory Disclosures</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <p className="text-blue-800 mb-3">May be necessary to comply with applicable laws and regulations:</p>
                        <ul className="space-y-2 text-sm text-blue-700">
                          <li className="flex items-start gap-2">
                            <ChevronRight className="h-4 w-4 text-blue-600 mt-0.5" />
                ...
                <section id="data-security" className="mb-12">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <Card className="border-green-200 bg-green-50">
                      <CardHeader>
                        <CardTitle className="text-lg text-green-900">Technical Safeguards</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <ul className="space-y-2 text-sm text-green-700">
                          <li className="flex items-start gap-2">
                    ...
                    <Card className="border-blue-200 bg-blue-50">
                      <CardHeader>
                        <CardTitle className="text-lg text-blue-900">Administrative Safeguards</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <ul className="space-y-2 text-sm text-blue-700">
                          <li className="flex items-start gap-2">
                ...
                <section id="privacy-rights" className="mb-12">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <Card className="border-[#7f5efd]/20 bg-[#f5f3ff]/30">
                      <CardHeader>
                        <CardTitle className="text-lg text-gray-900">Access and Portability Rights</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <p className="text-gray-700">Request information about the personal data we have collected:</p>
                        <ul className="space-y-2 text-sm text-gray-600">
                          <li className="flex items-start gap-2">
                            <ChevronRight className="h-4 w-4 text-[#7f5efd] mt-0.5" />
                    ...
                    <Card className="border-gray-200">
                      <CardHeader>
                        <CardTitle className="text-lg text-gray-900">Correction and Update Rights</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <p className="text-gray-700">Ensure your personal information is accurate and up-to-date:</p>
                        <ul className="space-y-2 text-sm text-gray-600">
                          <li className="flex items-start gap-2">
                            <ChevronRight className="h-4 w-4 text-[#7f5efd] mt-0.5" />
                    ...
                    <Card className="border-gray-200">
                      <CardHeader>
                        <CardTitle className="text-lg text-gray-900">Deletion Rights</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                    ...
                    <Card className="border-gray-200">
                      <CardHeader>
                        <CardTitle className="text-lg text-gray-900">Communication Preferences</CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <p className="text-gray-700">Manage how we communicate with you:</p>
                        <ul className="space-y-2 text-sm text-gray-600">
                          <li className="flex items-start gap-2">
                            <ChevronRight className="h-4 w-4 text-[#7f5efd] mt-0.5" />
                ...
                <section id="data-retention" className="mb-12">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <Card className="border-blue-200 bg-blue-50">
                      <CardHeader>
                        <CardTitle className="text-lg text-blue-900">Account Information</CardTitle>
                      </CardHeader>
                      <CardContent className="pt-4">
                        <p className="text-sm text-blue-800 mb-2">Retained for the duration of your relationship with us</p>
                    ...
                    <Card className="border-green-200 bg-green-50">
                      <CardHeader>
                        <CardTitle className="text-lg text-green-900">Transaction Data</CardTitle>
                      </CardHeader>
                      <CardContent className="pt-4">
                        <p className="text-sm text-green-800 mb-2">Governed by financial services regulations</p>
                    ...
                    <Card className="border-purple-200 bg-purple-50">
                      <CardHeader>
                        <CardTitle className="text-lg text-purple-900">Communication Data</CardTitle>
                      </CardHeader>
                      <CardContent className="pt-4">
                        <p className="text-sm text-purple-800 mb-2">Retained for customer support and service improvement</p>
                ...
                <section id="children-privacy" className="mb-12">
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                    <h3 className="font-semibold text-red-900 mb-3">Important Notice</h3>
