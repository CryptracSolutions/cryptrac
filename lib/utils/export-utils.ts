  ...
  return new Promise((resolve) => {
    ...
    autoTable(doc, {
      ...
      didDrawPage: () => {
        ...
        doc.text('Generated by Cryptrac Payment Platform', margin, pageHeight - 12)
        doc.text(formatDateTimeLong(new Date().toISOString()), pageWidth - margin, pageHeight - 12, { align: 'right' })
        ...
        doc.setFontSize(7)
        doc.text(disclaimerLines, pageWidth / 2, pageHeight - 7, { align: 'center' })
      }
    })
